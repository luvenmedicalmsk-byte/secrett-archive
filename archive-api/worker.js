...
const _TG_DOMVOCAB = {
  ...
  technology: ['кибератак','хакер','взлом','утечк','уязвим','cve','cisa','ddos','вредоносн','malware','дата-центр','цод','облач','спутник','глонасс','gps','нейросет','gmail','телеком','оператор связи','энергосет','подстанц','платёжн','авторизац','сервер','ядерн','радиац','аэс','реактор'],
