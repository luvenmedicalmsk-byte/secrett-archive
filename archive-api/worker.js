...
const _TG_DOMVOCAB = {
  ...
  social: ['эпидеми','пандеми','вспышк','заболевани','вирус','инфекц','воз ','больниц','здравоохран','врач','миграц','беженц','демограф','рождаемост','смертност','убыль','голод','продовольств','карантин','вакцин','образован','школ','студент'],
  climate: ['наводнен','паводок','землетряс','оползен','шторм','ураган','тайфун','циклон','засух','лесн пожар','ливень','снегопад','аномальн жар','вулкан','цунами','сель ','штормов']
};
...
var _CFM_EXPECT = ['ожидается','планируется','может привести','возможно','не исключен','рассматрива','предполага','как ожидается','планирует'];
var _CFM_NEGOT = ['переговор','обсужда','ведут диалог','на стадии','консультаци','стороны обсуждают','раунд перегов','диалог о'];
var _CFM_PRELIM = ['предварительн','проект соглашения','меморандум','рамочн','договорённость о намерениях','согласовали рамки','согласованы рамки','близки к соглашению','приблизились к соглашению'];
var _CFM_STATE = ['заявил','сообщил о намерении','призвал','пригрозил','предложил','выразил готовность','выступил с инициатив'];
var _CFM_GRAND = ['достигли соглашения','достигли договорённости','договорились о мире','договорились о прекращении','подписано соглашение','подписали соглашение','историческое соглашение','соглашение о прекращении войны','соглашение о прекращении конфликта','пролив открыт','открыт ормузский','объявили о мире'];
...
function _tgConfirmLevel(text){
  ...
  if (_cfmHas(b,_CFM_GRAND)) return 'preliminary';
  return 'confirmed';
}
