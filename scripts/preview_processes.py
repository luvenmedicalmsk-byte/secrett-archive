...
_MANUAL_INFRA = {
 'infra-a5ee3518': {
   'waves': [
     ...
     # 30.07: событие ПОПАЛО в mems автоматически (mc 4→5, Пенза в процессе),
     # но хроника берётся из waves и перезаписывает авто-сборку — см. ADR-041.
     # До решения по ADR ручной ввод обязателен даже когда движок событие видит.
     ('2026-07-30','Склад Wildberries, Пенза — попадание нескольких дронов','Пензенская область',76),
   ],
   ...
   'covered': [
     ...
     {'zone':'Пензенская область','hubs':['Пенза'],'significance':'седьмая волна, попадание дронов по складу'},
   ],
   'open': [
     ...
     # Расширение 30.07 после подтверждения Пензы: соседние узлы ПФО и ЦФО,
     # замыкающие кольцо вокруг подтверждённых Пензенской, Рязанской,
     # Тамбовской областей и Удмуртии.
     {'zone':'Ульяновская область','hubs':['Ульяновск','Димитровград'],'significance':'узел ПФО между подтверждённой Пензой и Татарстаном'},
     {'zone':'Республика Мордовия','hubs':['Саранск','Рузаевка'],'significance':'сосед подтверждённой Пензенской области, узел Рузаевка'},
     {'zone':'Липецкая область','hubs':['Липецк','Елец'],'significance':'узел ЦФО между подтверждёнными Тамбовской и Рязанской'},
...
_MANUAL_PROVENANCE = {
    'infra-a5ee3518': {
        ...
        '2026-07-30': {'origin': 'manual_sync',
                       'reason': 'in_mems_but_timeline_overridden_by_waves'},
    },
}
