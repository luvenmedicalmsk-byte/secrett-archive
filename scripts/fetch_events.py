...
_RETRO_TITLE_RE = re.compile(
    ...
    r'катастроф\w*|авари\w*|теракт\w*|крушени\w*|обрушени\w*)'
...
_RETRO_DAMAGE_RE = re.compile(
    r'(?:унесл\w*|погибл\w*|жертв\w*|ранил\w*|разрушил\w*)[^.]{0,80}?(?:19|20)\d{2}'
    r'|(?:19|20)\d{2}\s*год\w*[^.]{0,80}?(?:унесл|погибл|жертв|ранил|разрушил)', re.I)
