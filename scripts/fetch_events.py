...
_DOMAIN_VOCAB = {
    'geopolitics': ('войн','военн','армия','войск','ракет','дрон','бпла','обстрел','удар по','санкц','эмбарго','пошлин','нато','оон','переговор','саммит','дипломат','посол','мид','госдеп','кремл','пентагон','переворот','мобилизац','конфликт','границ','боев','теракт','оккупац','аннекс','вторжен','наступлен','путин','трамп','зеленск','киев','еврокоми','танкер','судоходств','всу','пво','снаряд','госпереворот'),
