...
_CANON_TYPE = [
    ...
    (r'лихорадк|эпидеми|пандеми|вспышк\w* (?:инфекц|вирус|болезн|заболеван)|вирус\w* угроз|рост заболеваемост|случа\w+ заражени|массов\w+ (?:отравлени|заражени)|очаг\w* инфекц|заболел\w* \d', 'Эпидемиологический риск'),
