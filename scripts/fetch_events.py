...
def _recompute_severity(ev):
    ...
    if any(w in b for w in ('опроверг','опровергл','опровержени','не соответствует действительности','назвал фейк','назвала фейк','это фейк','фейком')):
        sev = min(sev, 38)
