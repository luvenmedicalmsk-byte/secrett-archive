...
_GEOECON_OVERRIDE_FROM = {'Розничная торговля','Экономический сигнал','Валютный рынок','Топливный рынок','Инфляция','Фондовый рынок','Государственный долг','Банковская стабильность','Экономический спад', None}
