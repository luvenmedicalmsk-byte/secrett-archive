...
DOMAIN_RULES = {
    "climate": {
        ...
        "keywords": [
            ...
            "жара","жаркая","жаркую","жаркой","аномальная жара","аномальной жары",
            "тепловая волна","аномальная температура","аномальной температуры",
            "рекордная жара","рекордную жару","экстремальная жара","изнемогают от жары",
            "утонул","утонули","захлебнул","захлебнулись","перегрев","тепловой удар"
        ],
        "weight": 1.0,
    ...
    "economy": {
        ...
        "exclude": ["military","armed","weapon","flood","wildfire","earthquake","hack",
                    ...
                    "утонул","утонули","захлебнул","жара","жаркая","тепловая волна","аномальная жара","изнемогают от жары"]
    },
    "geopolitics": {
...
from geo_resolver import ru_subject as ru_subject_in, RU_SUBJECTS as _RU_SUBJECTS
...
_DOMAIN_VOCAB = {
    ...
    'climate': ('наводнен','паводок','землетряс','оползен','шторм','ураган','тайфун','циклон','засух','лесн пожар','ливень','снегопад','аномальн жар','вулкан','цунами','сель ','штормов','пожар','очаг','задымл',' дым','смог','режим чс','чрезвычайн ситуац','эвакуир','жара','жару','жары','жарк','тепловая волна','аномальн температур','рекордн жар','экстремальн жар','изнемогают от жары','тепловой удар','перегрев','утонул','утонули','захлебнул'),
}
