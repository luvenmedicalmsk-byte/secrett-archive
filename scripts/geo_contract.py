...
_STMT = re.compile(r'(заявил|заявля|обвиня|обвинил|предупре|пригроз|призва|призыва|осудил|раскрыл|настаива|потребова|выразил|звучат предложени|предлагает ограничить|предложил ограничить)', re.I)
_ATTADJ = re.compile(r'(?:росси|укра|американ|израил|иран|турец|кита|пакистан|афган|сирийск|ливан|йеменск|польск|британск|немец|француз)[а-яё]*\s+(?:беспилотник|бпла|дрон|ракет|снаряд|боевик|войск|сил[аыу]|формирован|авиаци|артиллер|диверсант|миллиардер|бизнесмен|гражданин|гражданк|политик|журналист|дипломат|активист)', re.I)
